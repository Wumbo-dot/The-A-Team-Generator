...
const siteGenerator = require('./lib/src/generated-site.js');
const fs = require("fs");
const path = require("path");

const generatedSite = require('./lib/src/generated-site.js');
...
const buildTeam = () => {
    console.log(`
        ...
        fs.writeFileSync(outputPath, generatedSite(teamMembers), "UTF-8");
}
promptManager();